...
@section('content')
    <div class="app-title">
        ...
        <a href="{{ route('admin.subtopic.create') }}" class="btn btn-primary pull-right">Add New</a>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#sampleTable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.subtopic.index') }}",
                columns: [
                    ...
                    {data: 'id', name: 'id',orderable: false, searchable: false,
                        render: function( data, type, full, meta ) {
                            var URL = "{{url('admin/subtopic')}}/"+data+'/edit';
                            return '<div class="btn-group" role="group" aria-label="Second group"><a href="'+URL+'" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a><a href="#" data-id="'+data+'" class="sa-remove btn btn-sm btn-danger edit-btn"><i class="fa fa-trash"></i></a></div>';
                        }
                    },
                ],
            });
            ...
            $(document).on('click','.sa-remove',function(){
                ...
                function(isConfirm){
                  if (isConfirm) {
                    window.location.href = "subtopic/"+categoryId+"/delete";
                    } else {
            ...
            $(document).on('change','input[id="toggle-block"]',function(){
                ...
                $.ajax({
                    type:'POST',
                    dataType:'JSON',
                    url:"{{route('admin.subtopic.updateStatus')}}",
