...
@section('content')
        ...
        <div class="app-title">
            <div class="active-wrap">
                ...
                <div class="form-group">
                    <button class="btn btn-primary" type="button" id="btnSave"><i class="fa fa-fw fa-lg fa-check-circle"></i>Update Subject</button>
                    <a class="btn btn-secondary" href="{{ route('admin.subject.index') }}"><i class="fa fa-fw fa-lg fa fa-angle-left"></i>Back</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row section-mg row-md-body no-nav">
        <div class="col-md-12 mx-auto">
            <div class="tile">
                <form action="{{ route('admin.subject.update') }}" method="POST" role="form" enctype="multipart/form-data" id="form1">
                    @csrf
