...
@section('content')
    <div class="app-title">
        ...
        <a href="{{ route('admin.class.create') }}" class="btn btn-primary pull-right">Add New</a>
    </div>
    ...
    <script type="text/javascript">
        $(function () {
                ...
                columns: [
                    ...
                    {data: 'id', name: 'id',orderable: false, searchable: false,
                        render: function( data, type, full, meta ) {
                            if(full.image != null){
                                return "<img style='width: 150px;height: 100px;' src='{{ asset('class')}}/"+full.image+"'>";
                            }else{
                                return 'N/A';
                            }
                        }
                    ...
                    {data: 'id', name: 'id',orderable: false, searchable: false,
                        render: function( data, type, full, meta ) {
                            var URL = "{{url('admin/class')}}/"+data+'/edit';
            ...
            $(document).on('click','.sa-remove',function(){
                ...
                function(isConfirm){
                  if (isConfirm) {
                    window.location.href = "class/"+categoryId+"/delete";
                    } else {
            ...
            $(document).on('change','input[id="toggle-block"]',function(){
                ...
                $.ajax({
                    type:'POST',
                    dataType:'JSON',
                    url:"{{route('admin.class.updateStatus')}}",
