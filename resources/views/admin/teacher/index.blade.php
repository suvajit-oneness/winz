...
@section('content')
   <div class="fixed-row">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-file-text"></i> {{ 'Teacher' }}</h1>
            <p>{{ 'list of Teachers' }}</p>
        </div>
        <a href="{{ route('admin.teacher.create') }}" class="btn btn-primary pull-right">Add New</a>
    </div>
    </div>
            ...
            $('#sampleTable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'id', name: 'id',orderable: false, searchable: false,
                        render: function( data, type, full, meta ) {
                            var URL = "{{url('admin/teacher')}}/"+data+'/edit';
