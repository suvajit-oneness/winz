    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#sampleTable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.couponcode.index') }}",
                columns: [
                    {data: 'coupon_code', name: 'coupon_code'},
                    {data: 'id', name: 'id',
                        render: function( data, type, full, meta ) {
                            return getDateFormat(full.start_date);
                        }
                    },
                    {data: 'id', name: 'id',
                        render: function( data, type, full, meta ) {
                            return getDateFormat(full.end_date);
                        }
                    },
                    {data: 'id', name: 'id',
                        render: function( data, type, full, meta ) {
                            if(full.offer_type == 1){
                                ...
                                return "Offer in percentage";
                            }
                        }
                    },
                    {data: 'offer_rate', name: 'offer_rate'},
                    {data: 'id', name: 'id',
                        render: function( data, type, full, meta ) {
                    ...
                    {data: 'id', name: 'id',orderable: false, searchable: false,
                        render: function( data, type, full, meta ) {
                            var URL = "{{url('admin/couponcodes')}}/"+data+'/edit';
