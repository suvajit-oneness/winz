    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="tile">
                ...
                <hr>
                <form action="{{ route('admin.couponcode.store') }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    <div class="tile-body">
                        <div class="form-group">
                            <label class="control-label" for="coupon_name"> Coupon Name <span class="m-l-5 text-danger"> *</span></label>
                            <input class="form-control @error('coupon_name') is-invalid @enderror" type="text" name="coupon_name" id="coupon_name" value="{{ old('coupon_name') }}"/>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('offer_rate') is-invalid @enderror" type="text" name="offer_rate" id="offer_rate" value="{{ old('offer_rate') }}"/>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('maximum_time_of_use') is-invalid @enderror" type="text" name="maximum_time_of_use" id="maximum_time_of_use" value="{{ old('maximum_time_of_use') }}"/>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('maximum_user_can_use') is-invalid @enderror" type="text" name="maximum_user_can_use" id="maximum_user_can_use" value="{{ old('maximum_user_can_use') }}"/>
