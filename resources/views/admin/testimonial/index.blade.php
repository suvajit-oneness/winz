...
@section('content')
    <div class="app-title">
        ...
        <a href="{{ route('admin.testimonial.create') }}" class="btn btn-primary pull-right">Add New</a>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
                ...
                columns: [
                    ...
                    {data: 'image', name: 'image',
                        render: function( data, type, full, meta ) {
                            if(data.length > 0){
                                return '<img style="width: 150px;height: 100px;" src="{{URL::to('/').'/testimonials'}}/'+data+'">';
                            }else{
                                return 'N/A';
                            }   
                        }
                    ...
                    {data: 'id', name: 'id',orderable: false, searchable: false,
                        render: function( data, type, full, meta ) {
                            var URL = "{{url('admin/testimonial')}}/"+data+'/edit';
            ...
            $(document).on('click','.sa-remove',function(){
                ...
                function(isConfirm){
                  if (isConfirm) {
                    window.location.href = "testimonial/"+blogid+"/delete";
                    } else {
