                ...
                <form action="{{ route('admin.packages.store') }}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('valid_upto') is-invalid @enderror" type="text" name="valid_upto" id="valid_upto" value="{{ old('valid_upto') }}" onkeypress="return event.charCode >= 48 && event.charCode <= 57"/>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('price') is-invalid @enderror" type="text" name="price" id="price" value="{{ old('price') }}" onkeypress="return event.charCode >= 48 && event.charCode <= 57"/>
                            @error('price') {{ $message ?? '' }} @enderror
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="name">Offered Price<span class="m-l-5 text-danger"> *</span></label>
                            <input class="form-control @error('offered_price') is-invalid @enderror" type="text" name="offered_price" id="offered_price" value="{{ old('offered_price') }}" onkeypress="return event.charCode >= 48 && event.charCode <= 57"/>
